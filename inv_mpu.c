...
//==============================================================================
//==============================================================================
// The following modifications were made to port to Linux for the J100 / J120
// TX1 carrier board.

#define MPU9250

// i2c_read and i2c_write are implemented in inv_mpu_spi_wrapper.c
...
// Interrupt pin is ignored (for now)
static void reg_int_cb(struct int_param_s *int_param)
{
}
